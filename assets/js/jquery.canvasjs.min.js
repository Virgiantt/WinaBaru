...
/* 
 CanvasJS Chart - v3.9.0 Beta 1 - https://canvasjs.com/ 
 Copyright 2024 fenopix
...
titleWrap:!0,titleMaxWidth:null,titleBackgroundColor:w?"transparent":null,titleBorderColor:w?"transparent":null,titleBorderThickness:0,titleCornerRadius:0,titleTextAlign:"left",labelAngle:0,labelFontFamily:"arial",labelFontColor:"black",labelFontSize:12,labelFontWeight:"normal",labelFontStyle:"normal",labelAutoFit:!0,labelWrap:!0,labelMaxWidth:null,labelFormatter:null,labelBackgroundColor:w?"transparent":null,labelBorderColor:w?"transparent":null,labelBorderThickness:0,labelCornerRadius:0,labelPlacement:"outside",
...
whiskerColor:null,whiskerLength:null,stemThickness:2,stemColor:null,stemDashType:"solid",upperBoxColor:"white",lowerBoxColor:"white",type:"column",xValueType:"number",axisXType:"primary",axisYType:"primary",axisXIndex:0,axisYIndex:0,xValueFormatString:null,yValueFormatString:null,zValueFormatString:null,percentFormatString:null,showInLegend:!1,legendMarkerType:null,legendMarkerColor:null,legendText:null,legendMarkerBorderColor:w?"transparent":null,legendMarkerBorderThickness:0,markerType:"circle",
...
this.backgroundColor,this.borderColor);this.ctx.fillStyle=this.fontColor;for(w=0;w<this._wrappedText.lines.length;w++)G=this._wrappedText.lines[w],"right"===this.textAlign?t=this.width-G.width-this.rightPadding:"left"===this.textAlign?t=this.leftPadding:"center"===this.textAlign&&(t=(this.width-(this.leftPadding+this.rightPadding))/2-G.width/2+this.leftPadding),this.ctx.fillText(G.text,t,A),A+=G.height;this.ctx.font=n;d&&this.ctx.restore()}};ja.prototype.setText=function(d){this.text=d;this._isDirty=
!0;this._wrappedText=null};ja.prototype.measureText=function(){this._lineHeight=Za(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ja.prototype._getLineWithWidth=function(d,n,w){d=String(d);if(!d)return{text:"",width:0};var t=w=0,A=d.length-1,G=Infinity;for(this.ctx.font=this._getFontString();t<=A;){var G=Math.floor((t+A)/2),C=d.substr(0,
G+1);w=this.ctx.measureText(C).width;if(w<n)t=G+1;else if(w>n)A=G-1;else break}w>n&&1<C.length&&(C=C.substr(0,C.length-1),w=this.ctx.measureText(C).width);n=!0;if(C.length===d.length||" "===d[C.length])n=!1;n&&(d=C.split(" "),1<d.length&&d.pop(),C=d.join(" "),w=this.ctx.measureText(C).width);return{text:C,width:w}};ja.prototype._wrapText=function(){var d=new String(Ga(String(this.text))),n=[],w=this.ctx.font,t=0,A=0;this.ctx.font=this._getFontString();if(0===this.frontSize)A=t=0;else for(;0<d.length;){var G=
this.maxHeight-(this.topPadding+this.bottomPadding),C=this._getLineWithWidth(d,this.maxWidth-(this.leftPadding+this.rightPadding),!1);C.height=this._lineHeight;n.push(C);var H=A,A=Math.max(A,C.width),t=t+C.height,d=Ga(d.slice(C.text.length,d.length));G&&t>G&&(C=n.pop(),t-=C.height,A=H)}this._wrappedText={lines:n,width:A,height:t};this.width=A+(this.leftPadding+this.rightPadding);this.height=t+(this.topPadding+this.bottomPadding);this.ctx.font=w};ja.prototype._getFontString=function(){var d;d=""+(this.fontStyle?
this.fontStyle+" ":"");d+=this.fontWeight?this.fontWeight+" ":"";d+=this.fontSize?this.fontSize+"px ":"";var n=this.fontFamily?this.fontFamily+"":"";!w&&n&&(n=n.split(",")[0],"'"!==n[0]&&'"'!==n[0]&&(n="'"+n+"'"));return d+=n};pa(Va,T);pa(Aa,T);Aa.prototype.setLayout=function(){if(this.text){var d=this.dockInsidePlotArea?this.chart.plotArea:this.chart,w=d.layoutManager.getFreeSpace(),t=w.x1,A=w.y1,G=0,H=0,C=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?40:0,O,L;this.textAlign=
n(this.options.textAlign)?this.horizontalAlign:this.textAlign;"top"===this.verticalAlign||"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=w.width-4-C*("center"===this.horizontalAlign?2:1)),H=0.5*w.height-this.margin-2,G=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=w.height-4),H=0.5*w.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=w.width-4),H=0.5*
w.height-4));var Q;n(this.padding)||"number"!==typeof this.padding?n(this.padding)||"object"!==typeof this.padding||(Q=this.padding.top?this.padding.top:this.padding.bottom?this.padding.bottom:0,Q+=this.padding.bottom?this.padding.bottom:this.padding.top?this.padding.top:0):Q=2*this.padding;this.wrap||(H=Math.min(H,1.5*this.fontSize+Q));H=new ja(this.ctx,{fontSize:this.fontSize,fontFamily:this.fontFamily,fontColor:this.fontColor,fontStyle:this.fontStyle,fontWeight:this.fontWeight,textAlign:this.textAlign,
verticalAlign:this.verticalAlign,borderColor:this.borderColor,borderThickness:this.borderThickness,backgroundColor:this.backgroundColor,maxWidth:this.maxWidth,maxHeight:H,cornerRadius:this.cornerRadius,text:this.text,padding:this.padding,textBaseline:"middle"});Q=H.measureText();"top"===this.verticalAlign||"bottom"===this.verticalAlign?("top"===this.verticalAlign?(A=w.y1+2+this.fontSize/2+4,L="top"):"bottom"===this.verticalAlign&&(A=w.y2-2-Q.height+this.fontSize/2+4,L="bottom"),"left"===this.horizontalAlign?
t=w.x1+2:"center"===this.horizontalAlign?t=w.x1+w.width/2-Q.width/2:"right"===this.horizontalAlign&&(t=w.x2-2-Q.width-C),O=this.horizontalAlign,this.width=Q.width,this.height=Q.height):"center"===this.verticalAlign&&("left"===this.horizontalAlign?(t=w.x1+2+(this.fontSize/2+4),A=w.y2-2-(this.maxWidth/2-Q.width/2),G=-90,L="left",this.width=Q.height,this.height=Q.width):"right"===this.horizontalAlign?(t=w.x2-2-(this.fontSize/2+4),A=w.y1+2+(this.maxWidth/2-Q.width/2),G=90,L="right",this.width=Q.height,
...
new ja(this.ctx,{x:0,y:0,maxWidth:w,maxHeight:this.itemWrap?r:this.lineHeight,angle:0,text:q.text,textAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"});q.textBlock.measureText();null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(v+d+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0)));if(!p||p.width+Math.round(q.textBlock.width+v+d+
(0===p.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))>h)p={items:[],width:0},k.push(p),this.height+=f,f=0;f=Math.max(f,q.textBlock.height?q.textBlock.height:this.lineHeight);q.textBlock.x=p.width;q.textBlock.y=0;p.width+=Math.round(q.textBlock.width+v+d+(0===p.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0));p.items.push(q);this.width=
Math.max(p.width,this.width)}else q.textBlock=new ja(this.ctx,{x:0,y:0,maxWidth:u,maxHeight:!0===this.itemWrap?r:1.5*this.fontSize,angle:0,text:q.text,textAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"}),q.textBlock.measureText(),null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(v+d+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:
...
q[f].title&&(q[f]._titleTextBlock=new ja(q[f].ctx,{text:q[f].title,fontSize:q[f].titleFontSize,fontFamily:q[f].titleFontFamily,fontWeight:q[f].titleFontWeight,fontColor:q[f].titleFontColor,fontStyle:q[f].titleFontStyle,borderColor:q[f].titleBorderColor,borderThickness:q[f].titleBorderThickness,backgroundColor:q[f].titleBackgroundColor,cornerRadius:q[f].titleCornerRadius,textBaseline:"middle",textAlign:q[f].titleTextAlign}));for(f=0;f<q.length;f++)if(q[f].title)switch(q[f]._position){case "left":q[f]._titleTextBlock.maxWidth=
...
2,d+e/2),c.stroke(),c.moveTo(a+e/2,d-e/2),c.lineTo(a-e/2,d+e/2),c.stroke())}},drawMarkers:function(a){for(var d=0;d<a.length;d++){var c=a[d];W.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();t.version="v3.9.0 Beta 1";window.CanvasJS&&(t&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=t)})();
