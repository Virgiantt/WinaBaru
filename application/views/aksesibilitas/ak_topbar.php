<div class="navigasi fixed-top">
	<div class="container-fluid">
		<div class="ltoggle">
			...
			<div>
				<img src="<?=base_url('assets/');?>img/images/logo.png" alt="" width="100%" class="logo">
			</div>
			<div class="fw-bold text-uppercase me-auto brand">
				<a href="<?=base_url('main_page');?>" style="color: white; text-decoration: none;">PERUMDAM TIRTA MAHAMERU</a>
			</div>
		</div>
		<div class="rtoggle">
